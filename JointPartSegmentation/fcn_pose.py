...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, nparts, input_dim):
        ...
        self.decoder = nn.Sequential(
                ...
                UpBlock(32, 32, upsample=True),
                # UpBlock(32, 32, upsample=True),
                nn.Conv2d(32, nparts, 1, 1),
                #nn.LeakyReLU()
                )
...
def fcn_pose(input_dim=11, pretrained=False, nparts=15):
    model = ResNet(BasicBlock, [1, 2, 6, 3], nparts=nparts, input_dim=input_dim)
